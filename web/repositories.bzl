...
def org_chromium_chromedriver():
    platform_http_file(
        ...
        amd64_urls = [
            "http://mirrors.corp.logiocean.com/file-store/chromedriver/chromedriver_linux64-2.41.zip",
...
def org_chromium_chromium():
    platform_http_file(
        ...
        amd64_urls = [
            "http://mirrors.corp.logiocean.com/file-store/chromium-browser-snapshots/chrome-linux-561732.zip",
            "https://commondatastorage.googleapis.com/chromium-browser-snapshots/Linux_x64/561732/chrome-linux-561732.zip",
        ],
        macos_sha256 =
...
def org_mozilla_firefox():
    platform_http_file(
        ...
        amd64_urls = [
            "http://ns1.corp.logiocean.com/file-store/firefox/firefox-61.0.2.tar.bz2",
...
def org_mozilla_geckodriver():
    platform_http_file(
        ...
        amd64_urls = [
            "http://ns1.corp.logiocean.com/file-store/geckodriver/geckodriver-v0.21.0-linux64.tar.gz",
