...
def org_chromium_chromedriver():
    platform_http_file(
        ...
        amd64_urls = [
            "http://mirrors.corp.logiocean.com/file-store/chromedriver/chromedriver_linux64-2.45.zip",
...
def org_chromium_chromium():
    platform_http_file(
        ...
        amd64_urls = [
            "http://mirrors.corp.logiocean.com/file-store/chromium-browser-snapshots/chrome-linux-587811.zip",
...
def org_mozilla_firefox():
    platform_http_file(
        ...
        amd64_urls = [
            "http://mirrors.corp.logiocean.com/file-store/firefox/firefox-63.0.1.tar.bz2",
...
def org_mozilla_geckodriver():
    platform_http_file(
        ...
        amd64_urls = [
            "http://mirrors.corp.logiocean.com/file-store/geckodriver/geckodriver-v0.23.0-linux64.tar.gz",
